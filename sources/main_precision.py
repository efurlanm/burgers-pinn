...
if __name__ == "__main__":
    ...
    output_filename = f"precision_results_data_{lambda_data_weight}_pde_{lambda_pde_weight}_epochs_{adam_epochs}_pdepoints_{num_pde_points}_seed_{seed_value}.npz"
