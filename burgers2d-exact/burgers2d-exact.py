# 2025-10-27
# script to calculate and visualize the exact analytical solution of the two-dimensional viscous Burgers' equation.
# To obtain an analytical solution, we use the **Cole-Hopf transformation**.
